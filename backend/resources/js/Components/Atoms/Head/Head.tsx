...
export const HeadingPresenter = ({ tag: Tag, visualLevel, className, ...props }: PresenterProps) => (
  <Tag className={clsx([styles.h, styles[Tag], className])} {...props} />
)

export const HeadingUnderlinedPresenter = ({ tag: Tag, visualLevel, className, ...props }: PresenterProps) => (
  <Tag className={clsx([styles.h, styles[Tag], styles.underlined, className])} {...props} />
)

export const HeadingOutlinedPresenter = ({ tag: Tag, visualLevel, className, ...props }: PresenterProps) => (
  <Tag className={clsx([styles.h, styles[Tag], styles.outlined, className])} {...props} />
)

export const HeadingContainer = ({ presenter, level = 2, visualLevel, ...props }: ContainerProps) => {
...
export const HeadingOutlined = (props: ComponentProps) => (
  <HeadingContainer presenter={(presenterProps) => <HeadingOutlinedPresenter {...presenterProps} />} {...props} />
)
